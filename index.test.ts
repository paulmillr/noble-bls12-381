...
describe("bls12-381", () => {
  ...
  describe("aggregated pubkey vectors", () => {
    it("vector 1", async () => {
  ...
  describe("aggregated signature vectors", () => {
    it("vector 1", async () => {
    ...
    it("vector 2", async () => {
      ...
      expect(Buffer.from(aggregatedSignature).toString("hex")).toBe(
        "8d915d8e6572998aab657b52f557de1a70b13379b561d49e92e6aa85e147416620b5e8bba6935e3bbb88ea50c4a330910816183e0e69f3c5e7cc8d7d2e1f9626953dfb482ac2992ecb6ad30ba1fbf0a3e4fa582f0623180978b0b8e82fa14c05"
      );
    });
    it("vector 3", async () => {
      const [signature1, signature2] = await Promise.all([
        bls.sign("124315", 0x5d0n, 2),
        bls.sign(
          "900000",
          0x1a0111ea397fe69a4b1ba7b6434bacd764774b84f38512bf6730d2a0f6b0f6241eabfffeb153ffffb9feffffffffaaaan,
          2
      ...
      expect(Buffer.from(aggregatedSignature).toString("hex")).toBe(
        "8f4c3b3c516c24aa7a3287f9f0dffa449a2ddb19983002f1556724a66a2453cf38e6793c2da7feccda4623e05af5898206db6f72dbf754871ed6549170b038c64f8bf42c4feb9b38cd383828502d113a89a1580444349764cdb78ea7460e6587"
      );
    });
    it("vector 4", async () => {
      ...
      expect(Buffer.from(aggregatedSignature).toString("hex")).toBe(
        "98c3175e0bff9b8d5420f03e1dc562ffe78e2fb8d5b9f1eda5191b4228d7e921bfd210d3fac93332404745b0cadd3d8012f5722a1e822ff1b5d3d2b6cd7323aab335f90e429105e09d275e7bcb127454ea8b672651b97623bb69372e9971da00"
      );
    });
    it("vector 5", async () => {
      const signature = await bls.sign("124315", 0x5d0n, 1);
      const aggregatedSignature = await bls.aggregateSignatures([signature]);
      expect(Buffer.from(aggregatedSignature).toString("hex")).toBe(
        "b28284ea63b963b63f277a3dea8fdc0dc49f179411859cab73a3a38f9894d7865bd3065f562f90f81d8cf4d1640acaee0012113cfb132f971d359007a255009a629fe74579a80990cbb9e0137333becd9b9c492edf2ef5c601fa60def2556719"
      );
    });
  })
});
