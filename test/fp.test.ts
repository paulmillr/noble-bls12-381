...
describe('bls12-381 Fp', () => {
  ...
  describe('multiply', () => {
    ...
    it('sqrt', () => {
      ...
      expect(sqr1 && sqr1.value.toString()).toEqual('364533921369419647282142659217537440628656909375169620464770009670699095647614890229414882377952296797827799113624');
