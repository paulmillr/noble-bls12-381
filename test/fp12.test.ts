  ...
  it("Fp12 equality", () => {
    fc.assert(
      fc.property(fc.array(fc.bigInt(1n, Fq.ORDER), 12, 12), num => {
        const a = new Fq12(...num as BigintTwelve);
        const b = new Fq12(...num as BigintTwelve);
  ...
  it("Fp12 non-equality", () => {
    fc.assert(
      fc.property(
        ...
        fc.array(fc.bigInt(1n, Fq.ORDER), 12, 12),
        (num1, num2) => {
          const a = new Fq12(...num1 as BigintTwelve);
          const b = new Fq12(...num2 as BigintTwelve);
    ...
    fc.assert(
      fc.property(
        ...
        (num1, num2, num3) => {
          const a = new Fq12(...num1 as BigintTwelve);
          const b = new Fq12(...num2 as BigintTwelve);
          const c = new Fq12(...num3 as BigintTwelve);
  ...
  it("Fp12 minus and negative equality", () => {
    fc.assert(
      fc.property(
        ...
        (num1) => {
          const a = new Fq12(...num1 as BigintTwelve);
          const b = new Fq12(...num1 as BigintTwelve);
