  ...
  it("Fp12 equality", () => {
    fc.assert(
      fc.property(fc.array(fc.bigInt(1n, Fq.ORDER), 12, 12), num => {
        const a = Fq12.fromTuple(num as BigintTwelve);
        const b = Fq12.fromTuple(num as BigintTwelve);
  ...
  it("Fp12 non-equality", () => {
    fc.assert(
      fc.property(
        ...
        fc.array(fc.bigInt(1n, Fq.ORDER), 12, 12),
        (num1, num2) => {
          const a = Fq12.fromTuple(num1 as BigintTwelve);
          const b = Fq12.fromTuple(num2 as BigintTwelve);
    ...
    fc.assert(
      fc.property(
        ...
        (num1, num2, num3) => {
          const a = Fq12.fromTuple(num1 as BigintTwelve);
          const b = Fq12.fromTuple(num2 as BigintTwelve);
          const c = Fq12.fromTuple(num3 as BigintTwelve);
  ...
  it("Fp12 minus and negative equality", () => {
    fc.assert(
      fc.property(
        ...
        (num1) => {
          const a = Fq12.fromTuple(num1 as BigintTwelve);
          const b = Fq12.fromTuple(num1 as BigintTwelve);
