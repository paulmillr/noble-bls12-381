...
export declare const Z2: Point<[bigint, bigint]>;
...
export declare function signatureToG2(signature: Bytes): Point<[bigint, bigint]>;
export declare function hashToG2(hash: Hash, domain: Bytes): Promise<Point<[bigint, bigint]>>;
